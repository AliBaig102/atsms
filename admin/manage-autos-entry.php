...
<head>
    ...
    <title>🚖Ride Hub | Manage Auto Entries</title>
    ...
    <div class="container-fluid vh-100 d-flex flex-column p-0">
        ...
        <div class="d-flex flex-grow-1 overflow-hidden">
            ...
            <div class="flex-grow-1 overflow-auto p-4">
                <h4 class="mb-4">Manage Auto Entries</h4>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $ret = mysqli_query($con, "SELECT * FROM tblstandentry WHERE VehicleType='Auto' ORDER BY EntryDate DESC");
                                    $cnt = 1;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= $row['Status'] ? htmlspecialchars($row['Status']) : '<span class="text-danger">Not Updated Yet</span>'; ?>
                                            </td>
                                            <td>
