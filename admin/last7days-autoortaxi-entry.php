...
if (isset($_GET['del'])) {
    ...
    echo "<script>window.location.href='last7days-autoortaxi-entry.php';</script>";
    exit();
}
?>
...
<head>
    ...
    <title>🚖Ride Hub | Last 7 Days Entries</title>
...
<body>
    <div class="container-fluid vh-100 d-flex flex-column p-0">
        ...
        <div class="d-flex flex-grow-1 overflow-hidden">
            ...
            <div class="flex-grow-1 overflow-auto p-4 main-content">
                <h4 class="mb-4">Last 7 Days Auto/Taxi Entries</h4>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM tblstandentry WHERE DATE(EntryDate) >= CURDATE() - INTERVAL 7 DAY";
    ...
    <script>
        function confirmDelete(id) {
            document.getElementById('confirmDeleteBtn').href = "last7days-autoortaxi-entry.php?del=" + id;
